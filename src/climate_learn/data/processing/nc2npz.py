...
def main():
    parser = ArgumentParser(description="Weatherbench convertion utility.")
    parser.add_argument("--root_dir")
    parser.add_argument("--save_dir")
    parser.add_argument("--variables", nargs="*")
    parser.add_argument("--start_train_year", type=int)
    parser.add_argument("--start_val_year", type=int)
    parser.add_argument("--start_test_year", type=int)
    ...
    convert_nc2npz(
        ...
        start_train_year=args.start_train_year,
